                        ...
                        <div class="cb-card">
                            ...
                            <div class="cb-card-body">
                                ...
                                <div class="cb-card-summary">
                                    <div class="cb-card-block">
                                        <p class="cb-card-prefix">תמיד תזכור את כוח-העל שלך:</p>
                                        <p class="cb-card-value">יש לך ${data.weapon || ''} 🗡️</p>
                                    </div>
                                    <div class="cb-card-block">
                                        <p class="cb-card-prefix">והכי חשוב להמשך הדרך:</p>
                                        <p class="cb-card-value">תזכור ${data.goal || ''} 🎯</p>
                                    </div>
                                </div>
